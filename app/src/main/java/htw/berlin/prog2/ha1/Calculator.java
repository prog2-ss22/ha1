...
public class Calculator {
    ...
    public void pressDigitKey(int digit) {
        ...
        //Wenn man -Key nutzt, steht am Anfang -0. Das wird in ein int konvertiert, um es mit der digit zu verrechnen.
        // Am Ende wird die negative Nummer wieder zu einem String konvertiert
        if (screen.equals("-0")) {
